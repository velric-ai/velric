...
import { MissionTemplate, UserMission, User, Project, ProjectDoc, IndustryTag, TargetRole } from '@/types';
...
export const mockMissionTemplates: MissionTemplate[] = [
  {
    ...
    skills: ['Python', 'System Design', 'LLMs', 'Architecture', 'Redis', 'Docker'],
  ...
  },
  {
    ...
    skills: ['NLP', 'Python', 'Machine Learning', 'Transformers', 'spaCy', 'PyTorch'],
  ...
  },
  {
    ...
    skills: ['JWT', 'OAuth2', 'Security', 'Authentication', 'Node.js', 'Express'],
  ...
  },
  {
    ...
    details: {
      ...
      technologies: ['React', 'TypeScript', 'Webpack', 'React DevTools', 'Lighthouse'],
      learningOutcomes: [
  ...
  },
  {
    ...
    skills: ['Python', 'Pandas', 'SQL', 'Visualization', 'ETL', 'Apache Airflow'],
    ...
    details: {
      ...
      technologies: ['Python', 'Pandas', 'Apache Airflow', 'PostgreSQL', 'Plotly'],
      learningOutcomes: [
        'ETL pipeline design',
  ...
  },
  {
    ...
    details: {
      ...
      technologies: ['Terraform', 'Kubernetes', 'AWS', 'Docker', 'Jenkins', 'Prometheus'],
      learningOutcomes: [
...
export const mockTargetRoles: TargetRole[] = [
  ...
  { id: 'tr-2', name: 'Senior Software Engineer', created_at: '2024-01-01T10:00:00Z' },
  { id: 'tr-3', name: 'Full Stack Developer', created_at: '2024-01-01T10:00:00Z' },
