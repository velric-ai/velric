        ...
        {showPasswordForm && (
          <div className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3 bg-[#2A2A2E] border border-white/10 rounded-lg focus:border-purple-500 focus:outline-none transition-colors"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handlePasswordChange}
                  className="w-full pl-12 pr-4 py-3 bg-[#2A2A2E] border border-white/10 rounded-lg focus:border-purple-500 focus:outline-none transition-colors"
            ...
            <button
              ...
              disabled={isSaving}
              className="w-full bg-gradient-to-r from-purple-500 to-blue-500 py-3 rounded-lg hover:scale-105 transition-all disabled:opacity-50 disabled:hover:scale-100"
            >
