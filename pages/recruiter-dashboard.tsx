    ...
    <>
      ...
      >
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
              ...
              <motion.div
                ...
                whileHover={{ scale: 1.02 }}
              >
                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-full blur-2xl -mr-16 -mt-16" />
                <div className="relative z-10">
                  ...
                  <p className="text-white/70">
                    Schedule interviews with candidates from your saved list or search results.
                  </p>
                </div>
              </motion.div>
        ...
        <ScheduleInterviewModal
          ...
          onScheduleInterview={(candidateId, candidateName, candidateEmail) => {
