...
const RequestDemo = () => {
  ...
  return (
    <div className="bg-[#0D0D0D] text-white relative overflow-hidden min-h-screen">
      ...
      {/* Header Section */}
      <motion.section
        className="text-center pt-36 pb-12 px-4 md:px-8 lg:px-16 max-w-3xl mx-auto relative z-10"
      ...
      >
        ...
        >
          <TypeAnimation
            ...
            speed={45} // slower, smoother typing
            deletionSpeed={35} // smoother backspacing
            cursor={true}
            repeat={Infinity}
            wrapper="span"
            style={{
      ...
      <section className="relative z-10 max-w-3xl mx-auto px-4 md:px-8 lg:px-16 pb-24">
        <motion.div
          className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur p-6 md:p-8 shadow-lg shadow-purple-800/10"
        ...
        >
          {submitted ? (
            ...
            >
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div>
                  ...
                  <select
                    id="focus-select"
                    name="focus"
                    className="w-full bg-transparent border border-white/15 rounded-xl px-4 py-3 outline-none focus:border-purple-400 transition-colors duration-300"
              ...
              <motion.button
                type="submit"
                whileHover={{ scale: 1.03, boxShadow: "0 0 20px rgba(124,58,237,0.5)" }}
                whileTap={{ scale: 0.97 }}
                className="w-full md:w-auto px-6 py-3 rounded-xl bg-gradient-to-r from-purple-500 to-sky-400 font-semibold transition-all duration-300"
              >
                Submit request
              </motion.button>
            </motion.form>
